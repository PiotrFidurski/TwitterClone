...
export type ConversationResult = ConversationSuccess | ConversationInvalidInputError;
...
export type FollowUserResult = UpdateResourceResponse | FollowUserInvalidInputError;
...
export type RepliesToTweetResult = RepliesToTweetSuccess | RepliesToTweetInvalidInputError;
...
export type DeleteTweetResult = DeleteResourceResponse | DeleteTweetInvalidInputError;
...
export type LikeTweetResult = UpdateResourceResponse | LikeTweetInvalidInputError;
...
export type SendMessageResult = SendMessageSuccess | SendMessageInvalidInputError;
...
export type MessageUserResult = MessageUserSuccess | MessageUserInvalidInputError;
...
export type ReadConversationResult = UpdateResourceResponse | ReadConversationInvalidInputError;
...
export type LeaveConversationResult = UpdateResourceResponse | LeaveConversationInvalidInputError;
...
export type SeeMessageResult = UpdateResourceResponse | SeeMessageInvalidInputError;
...
export type TweetLikesFieldsFragment = (
  { __typename?: 'Tweet' }
  & Pick<Tweet, 'id' | 'isLiked' | 'likesCount' | 'replyCount'>
  & { likes?: Maybe<Array<(
    { __typename?: 'User' }
    & Pick<User, 'id'>
  )>> }
...
export type LeaveConversationMutation = (
  ...
  & { leaveConversation: (
    ...
    & { node?: Maybe<{ __typename?: 'User' } | { __typename?: 'Tweet' } | (
      { __typename?: 'Conversation' }
    ...
    ) | { __typename?: 'LeftConversationAt' } | { __typename?: 'LastSeenMessage' }> }
  ) | (
    { __typename: 'LeaveConversationInvalidInputError' }
    & Pick<LeaveConversationInvalidInputError, 'message' | 'conversationId'>
  ) }
);
...
export type MessageUserMutation = (
  ...
  & { messageUser: (
    ...
    { __typename: 'MessageUserInvalidInputError' }
    & Pick<MessageUserInvalidInputError, 'message' | 'userId'>
  ) }
);
...
export type ReadConversationMutation = (
  ...
  & { readConversation: (
    ...
    { __typename: 'ReadConversationInvalidInputError' }
    & Pick<ReadConversationInvalidInputError, 'message' | 'messageId' | 'conversationId'>
  ) }
);
...
export type SendMessageMutation = (
  ...
  & { sendMessage: (
    ...
    { __typename: 'SendMessageInvalidInputError' }
    & Pick<SendMessageInvalidInputError, 'message' | 'senderId' | 'receiverId' | 'text' | 'conversationId'>
  ) }
);
...
export type SeeMessageMutation = (
  ...
  & { seeMessage: (
    { __typename: 'UpdateResourceResponse' }
    & Pick<UpdateResourceResponse, 'status'>
    & { node?: Maybe<{ __typename?: 'User' } | { __typename?: 'Tweet' } | { __typename?: 'Conversation' } | { __typename?: 'LeftConversationAt' } | (
      { __typename?: 'LastSeenMessage' }
      & Pick<LastSeenMessage, 'id' | 'userId' | 'lastSeenMessageId'>
    )> }
  ) | (
    { __typename: 'SeeMessageInvalidInputError' }
    & Pick<SeeMessageInvalidInputError, 'message' | 'messageId'>
  ) }
);
...
export type MessagesQuery = (
  ...
  & { messages: (
    ...
    { __typename: 'MessagesInvalidInputError' }
    & Pick<MessagesInvalidInputError, 'message' | 'conversationId' | 'cursorId' | 'limit' | 'leftAtMessageId'>
  ) }
);
...
export type LeftAtQuery = (
  ...
  & { leftAt: (
    ...
    { __typename: 'LeftAtInvalidInputError' }
    & Pick<LeftAtInvalidInputError, 'message' | 'userId' | 'conversationId'>
  ) }
);
...
export type CreateTweetMutation = (
  ...
  & { createTweet?: Maybe<(
    { __typename: 'Tweet' }
    & Pick<Tweet, 'id' | 'body' | 'conversationId' | 'inReplyToId'>
    & { owner?: Maybe<(
      { __typename?: 'User' }
    ...
    { __typename: 'CreateTweetInvalidInputError' }
    & Pick<CreateTweetInvalidInputError, 'message' | 'conversationId' | 'inReplyToId'>
...
export type LikeTweetMutation = (
  ...
  & { likeTweet?: Maybe<(
    ...
    & { node?: Maybe<(
      ...
      { __typename?: 'LeftConversationAt' }
      & Pick<LeftConversationAt, 'id'>
    ) | (
      { __typename?: 'LastSeenMessage' }
      & Pick<LastSeenMessage, 'id'>
    )> }
  ) | (
    { __typename?: 'LikeTweetInvalidInputError' }
    & Pick<LikeTweetInvalidInputError, 'message' | 'tweetId'>
  )> }
);
...
export type RepliesToTweetMutation = (
  { __typename?: 'Mutation' }
  & { repliesToTweet: (
    { __typename: 'RepliesToTweetSuccess' }
    & { edges?: Maybe<Array<(
    ...
    { __typename: 'RepliesToTweetInvalidInputError' }
    & Pick<RepliesToTweetInvalidInputError, 'message' | 'tweetId'>
  ) }
);
...
export type ConversationQuery = (
  ...
  & { conversation: (
    ...
    { __typename: 'ConversationInvalidInputError' }
    & Pick<ConversationInvalidInputError, 'message' | 'tweetId' | 'conversationId'>
  ) }
);
...
export type RepliesQuery = (
  ...
  & { replies: (
    ...
    { __typename?: 'TweetsInvalidInputError' }
    & Pick<TweetsInvalidInputError, 'message' | 'after' | 'tweetId'>
  ) }
);
...
export type TweetQuery = (
  ...
  & { tweet: (
    ...
    { __typename?: 'TweetInvalidInputError' }
    & Pick<TweetInvalidInputError, 'message' | 'tweetId'>
  ) }
);
...
export type UserLikedTweetsQuery = (
  { __typename?: 'Query' }
  & { userLikedTweets: (
    { __typename: 'TweetConnection' }
    & Pick<TweetConnection, 'count'>
    ...
    { __typename: 'TweetsInvalidInputError' }
    & Pick<TweetsInvalidInputError, 'message' | 'after' | 'userId'>
  ) }
);
...
export type UserTweetsAndRepliesQuery = (
  { __typename?: 'Query' }
...
export type FollowUserMutation = (
  ...
  & { followUser?: Maybe<(
    ...
    & { node?: Maybe<(
      ...
      & UserFollowerFieldsFragment
      & UserAvatarFieldsFragment
    ) | { __typename?: 'Tweet' } | { __typename?: 'Conversation' } | { __typename?: 'LeftConversationAt' } | { __typename?: 'LastSeenMessage' }> }
  ) | (
    { __typename?: 'FollowUserInvalidInputError' }
    & Pick<FollowUserInvalidInputError, 'message' | 'userId'>
  )> }
);
...
export const LeaveConversationDocument = gql`
  ...
  leaveConversation(conversationId: $conversationId) {
    ...
    `;
export type LeaveConversationMutationFn = Apollo.MutationFunction<LeaveConversationMutation, LeaveConversationMutationVariables>;
 ...
 * });
 */
export function useLeaveConversationMutation(baseOptions?: Apollo.MutationHookOptions<LeaveConversationMutation, LeaveConversationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<LeaveConversationMutation, LeaveConversationMutationVariables>(LeaveConversationDocument, options);
      }
...
export type LeaveConversationMutationOptions = Apollo.BaseMutationOptions<LeaveConversationMutation, LeaveConversationMutationVariables>;
...
export const ReadConversationDocument = gql`
  ...
  readConversation(conversationId: $conversationId, messageId: $messageId) {
    ...
    `;
export type ReadConversationMutationFn = Apollo.MutationFunction<ReadConversationMutation, ReadConversationMutationVariables>;
 ...
 * });
 */
export function useReadConversationMutation(baseOptions?: Apollo.MutationHookOptions<ReadConversationMutation, ReadConversationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ReadConversationMutation, ReadConversationMutationVariables>(ReadConversationDocument, options);
      }
...
export type ReadConversationMutationOptions = Apollo.BaseMutationOptions<ReadConversationMutation, ReadConversationMutationVariables>;
...
export function useSeeMessageMutation(baseOptions?: Apollo.MutationHookOptions<SeeMessageMutation, SeeMessageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SeeMessageMutation, SeeMessageMutationVariables>(SeeMessageDocument, options);
      }
...
export const MessagesDocument = gql`
    query messages($conversationId: String!, $cursorId: String, $limit: Int!, $leftAtMessageId: String) {
  messages(
    conversationId: $conversationId
    cursorId: $cursorId
    limit: $limit
 ...
 * });
 */
export function useLeftAtQuery(baseOptions: Apollo.QueryHookOptions<LeftAtQuery, LeftAtQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LeftAtQuery, LeftAtQueryVariables>(LeftAtDocument, options);
      }
export function useLeftAtLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LeftAtQuery, LeftAtQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LeftAtQuery, LeftAtQueryVariables>(LeftAtDocument, options);
        }
...
export type LeftAtQueryResult = Apollo.QueryResult<LeftAtQuery, LeftAtQueryVariables>;
 ...
 * });
 */
export function useUserInboxQuery(baseOptions?: Apollo.QueryHookOptions<UserInboxQuery, UserInboxQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UserInboxQuery, UserInboxQueryVariables>(UserInboxDocument, options);
      }
export function useUserInboxLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserInboxQuery, UserInboxQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UserInboxQuery, UserInboxQueryVariables>(UserInboxDocument, options);
        }
...
export type UserInboxQueryResult = Apollo.QueryResult<UserInboxQuery, UserInboxQueryVariables>;
...
export type RepliesToTweetMutationFn = Apollo.MutationFunction<RepliesToTweetMutation, RepliesToTweetMutationVariables>;
 ...
 * });
 */
export function useRepliesToTweetMutation(baseOptions?: Apollo.MutationHookOptions<RepliesToTweetMutation, RepliesToTweetMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RepliesToTweetMutation, RepliesToTweetMutationVariables>(RepliesToTweetDocument, options);
      }
export type RepliesToTweetMutationHookResult = ReturnType<typeof useRepliesToTweetMutation>;
export type RepliesToTweetMutationResult = Apollo.MutationResult<RepliesToTweetMutation>;
export type RepliesToTweetMutationOptions = Apollo.BaseMutationOptions<RepliesToTweetMutation, RepliesToTweetMutationVariables>;
 ...
 * });
 */
export function useUserLikedTweetsQuery(baseOptions: Apollo.QueryHookOptions<UserLikedTweetsQuery, UserLikedTweetsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UserLikedTweetsQuery, UserLikedTweetsQueryVariables>(UserLikedTweetsDocument, options);
      }
export function useUserLikedTweetsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserLikedTweetsQuery, UserLikedTweetsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UserLikedTweetsQuery, UserLikedTweetsQueryVariables>(UserLikedTweetsDocument, options);
        }
export type UserLikedTweetsQueryHookResult = ReturnType<typeof useUserLikedTweetsQuery>;
export type UserLikedTweetsLazyQueryHookResult = ReturnType<typeof useUserLikedTweetsLazyQuery>;
export type UserLikedTweetsQueryResult = Apollo.QueryResult<UserLikedTweetsQuery, UserLikedTweetsQueryVariables>;
 ...
 * });
 */
export function useUserTweetsAndRepliesQuery(baseOptions: Apollo.QueryHookOptions<UserTweetsAndRepliesQuery, UserTweetsAndRepliesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UserTweetsAndRepliesQuery, UserTweetsAndRepliesQueryVariables>(UserTweetsAndRepliesDocument, options);
      }
export function useUserTweetsAndRepliesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserTweetsAndRepliesQuery, UserTweetsAndRepliesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UserTweetsAndRepliesQuery, UserTweetsAndRepliesQueryVariables>(UserTweetsAndRepliesDocument, options);
        }
export type UserTweetsAndRepliesQueryHookResult = ReturnType<typeof useUserTweetsAndRepliesQuery>;
export type UserTweetsAndRepliesLazyQueryHookResult = ReturnType<typeof useUserTweetsAndRepliesLazyQuery>;
export type UserTweetsAndRepliesQueryResult = Apollo.QueryResult<UserTweetsAndRepliesQuery, UserTweetsAndRepliesQueryVariables>;
 ...
 * });
 */
export function useRandomUsersQuery(baseOptions: Apollo.QueryHookOptions<RandomUsersQuery, RandomUsersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RandomUsersQuery, RandomUsersQueryVariables>(RandomUsersDocument, options);
      }
export function useRandomUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RandomUsersQuery, RandomUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RandomUsersQuery, RandomUsersQueryVariables>(RandomUsersDocument, options);
        }
...
export type RandomUsersQueryResult = Apollo.QueryResult<RandomUsersQuery, RandomUsersQueryVariables>;
